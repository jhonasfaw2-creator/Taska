      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-16 items-center justify-between border-b bg-white px-6">
          ...
          <div className="flex items-center gap-4 ml-auto">
            <span className="text-sm text-gray-600">{user.firstName || user.phoneNumber}</span>
            <span className="rounded-full bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-700">{user.role}</span>
